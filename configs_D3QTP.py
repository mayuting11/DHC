...
#         dir_dic[worksheet.cell_value(i, column_dir)] = []
#         for j in range(1, worksheet.ncols, 3):
#             if worksheet.cell_value(i, j) != '':
#                 dir_dic[worksheet.cell_value(i, column_dir)].append(
#                     [worksheet.cell_value(i, j), worksheet.cell_value(i, j + 1),
